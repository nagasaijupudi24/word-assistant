...
Ms-Word Assistant is a Word add-in that integrates AI capabilities into Microsoft Word. It recognizes the content inside your document and acts as an intelligent assistant. The assistant can provide a summary of the document and additional insights using AI.

This project is built using the Word JavaScript API and Office Platform capabilities.


# Key Features

Recognize the content in the Word document.

Provide an AI-powered assistant experience.

Generate a summary of the document contents.

Enhance productivity with quick insights and contextual help.
